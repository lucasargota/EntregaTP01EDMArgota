...
public class CalculadoraController {
	...
	@GetMapping("/calculoDivicion")
	public ModelAndView getCalculoDivicion(@RequestParam (name = "num1") String num1 , @RequestParam (name = "num2") int num2){
		
		unaCalculadora.setNum1(Integer.valueOf(num1));
		unaCalculadora.setNum2(num2);
		
		int resultadoDivicion=unaCalculadora.dividir();
		
		ModelAndView modelView = new ModelAndView("resultado");
		modelView.addObject("resultadoDivicion", resultadoDivicion);
